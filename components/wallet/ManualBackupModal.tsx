...
/** ----- Component ------ */
export function ManualBackupModal({ visible, onClose, onFinish, wordCount = 12, title = "Wallet", mnemonic }: Props) {
				...
				{step === 1 && (
					<View style={styles.body}>
						...
						<View style={styles.tipCard}>
							...
							<Text style={[styles.centerTitle, { color: text }]}>Cụm từ bí mật này mở khóa ví của bạn</Text>

							<CheckLine checked text="Ví không có quyền truy cập vào khóa này" />
							<CheckLine
								checked
						...
						<Pressable
							...
							style={[styles.primaryBtn, { backgroundColor: canNext1 ? tint : "#A6A6AA" }]}
						>
				...
				{step === 2 && (
					<View style={[styles.body, { paddingTop: 6 }]}>
						...
						<Pressable
							disabled={!canNext2}
							onPress={() => setStep(3)}
							style={[styles.primaryBtn, { backgroundColor: canNext2 ? tint : "#A6A6AA" }]}
						>
							<Text style={styles.primaryText}>Tiếp tục</Text>
						</Pressable>
					</View>
				...
				{step === 3 && (
					<View style={[styles.body, { alignItems: "center", justifyContent: "center" }]}>
						...
						<Pressable
							disabled={!canNext3}
							onPress={() => setStep(4)}
							style={[styles.primaryBtn, { backgroundColor: canNext3 ? tint : "#A6A6AA", alignSelf: "stretch" }]}
						>
							<Text style={styles.primaryText}>Tiếp tục</Text>
						</Pressable>
					</View>
				...
				{step === 4 && (
					<View style={styles.body}>
						...
						{questions.map((pos) => {
							...
							// 2 lựa chọn nhiễu
							const randoms = sample(
								seed.filter((w) => w !== correct),
								2
							);
