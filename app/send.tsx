...
import { getWalletMnemonic } from "@/utils";
...
export default function SendScreen() {
	...
	const handleSend = async () => {
		const mnemonic = await getWalletMnemonic(defaultWallet?.id || "");
		if (!access_token || !sendToken?.token_address || !mnemonic) return;
		...
		<SafeAreaView style={[styles.container, { backgroundColor: background }]}>
			...
			<View style={{ paddingHorizontal: 16, marginVertical: 8 }}>
				<TextInput
					...
					style={[styles.search, { borderColor: "#C7C7CC", color: text, backgroundColor: background }]}
				/>
			</View>
					...
					<View style={{ gap: 4 }}>
						...
						<View style={[styles.inputWrap, { borderColor: "#C7C7CC", backgroundColor: background }]}>
							...
							<Pressable
								...
								style={[styles.inlineBtn, { marginLeft: 6 }]}
							>
