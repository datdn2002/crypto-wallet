...
export default function AccountScreen() {
    ...
    const settings: { icon: ReactElement; label: string; href: any }[] = [
        { icon: <Ionicons name="warning-outline" color={textColor} size={20} />, label: 'Cảnh báo giá', href: '/settings/price-alert' },
        { icon: <FontAwesome5 name="id-card" color={textColor} size={20} />, label: 'Sổ địa chỉ', href: '/settings/address-book' },
        { icon: <FontAwesome name="user" color={textColor} size={20} />, label: 'Tên người dùng', href: '/settings/username' },
        { icon: <Feather name="maximize" color={textColor} size={20} />, label: 'Quét mã QR', href: '/qr' },
        { icon: <MaterialIcons name="hub" color={textColor} size={20} />, label: 'Kết nối DApp', href: '/settings/connect-dapp' },
        { icon: <FontAwesome name="star-o" color={textColor} size={20} />, label: 'Ưa thích', href: '/settings/preferences' },
        { icon: <Ionicons name="shield-checkmark-outline" color={textColor} size={20} />, label: 'Bảo mật', href: '/settings/security' },
        { icon: <Ionicons name="notifications-outline" color={textColor} size={20} />, label: 'Thông báo', href: '/settings/notification' },
        { icon: <Feather name="help-circle" color={textColor} size={20} />, label: 'Trung tâm trợ giúp', href: '/settings/support' },
